...
%
%	See also PLOT
persistent sz_legend1 sz_legend
...
if isempty(sz_legend1)
sz_legend = 20000;
sz_legend1 = 20000;
else
    sz_legend1 = sz_legend1-1;
end
...
mk_new = markers{end-(sz_legend1-1)};
line_new = linestyle{end-(sz_legend1-1)};
col_new = colours{end-(sz_legend1-1)};
cellfun( @(x,y,z,a) set(x,'Marker',y,'LineStyle',z),mat2cell(h,ones(size(mk_new))), {mk_new}, {line_new});
